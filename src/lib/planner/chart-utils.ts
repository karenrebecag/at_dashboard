// Adapted from template-planner (Tremor chart utilities)

export type ColorUtility = 'bg' | 'stroke' | 'fill' | 'text'

export const chartColors = {
  atfxNavy: {
    bg: 'bg-atfx-navy dark:bg-atfx-navy',
    stroke: 'stroke-atfx-navy dark:stroke-atfx-navy',
    fill: 'fill-atfx-navy dark:fill-atfx-navy',
    text: 'text-atfx-navy dark:text-atfx-navy',
  },
  atfxOrange: {
    bg: 'bg-atfx-orange dark:bg-atfx-orange',
    stroke: 'stroke-atfx-orange dark:stroke-atfx-orange',
    fill: 'fill-atfx-orange dark:fill-atfx-orange',
    text: 'text-atfx-orange dark:text-atfx-orange',
  },
  blue: {
...
export const chartGradientColors = {
  atfxNavy:
    'from-atfx-navy/30 to-atfx-navy dark:from-atfx-navy/20 dark:to-atfx-navy',
  atfxOrange:
    'from-atfx-orange/30 to-atfx-orange dark:from-atfx-orange/20 dark:to-atfx-orange',
...
export const chartConditionalColors = {
  atfxNavy: {
    low: 'fill-atfx-navy/25 dark:fill-atfx-navy/35',
    medium: 'fill-atfx-navy/45 dark:fill-atfx-navy/55',
    high: 'fill-atfx-navy/70 dark:fill-atfx-navy/80',
    critical: 'fill-atfx-navy dark:fill-atfx-navy',
  },
  atfxOrange: {
    low: 'fill-atfx-orange/25 dark:fill-atfx-orange/35',
    medium: 'fill-atfx-orange/45 dark:fill-atfx-orange/55',
    high: 'fill-atfx-orange/70 dark:fill-atfx-orange/80',
    critical: 'fill-atfx-orange dark:fill-atfx-orange',
  },
  blue: {
